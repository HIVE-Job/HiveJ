    ...
    <div class="container">
        <div class="row mb-5 justify-content-center">
            <div class="col-md-7 text-center">
                <h2 class="section-title mb-2">Register as a Recruiter</h2>
            </div>
        </div>
            ...
            <div class="col-md-6">
                <form method="POST" action="{{ route('register') }}">
                    ...
                    <div class="row form-group">
                        <div class="col-md-12">
                            <label class="text-black" for="name">Partner / Company Name</label>
                    ...
                    <div class="row form-group">
                        <div class="col-md-12">
                            <label class="text-black" for="email">Partner / Company Email</label>
                    ...
                    <div class="row form-group">
                        <div class="col-md-12">
                            <center>
                                <button type="submit" class="btn btn-primary-cs btn-md text-white">Register</button>
                            </center>
                        </div>
                    </div>
                </form>
                <div class="row form-group">
                    <div class="col-md-12">
                        <p class="mb-0 text-center">Already have an account? <a class="text-primary" href="{{ route('login') }}">Login</a></p>
                    </div>
                </div>
            </div>
        </div>
