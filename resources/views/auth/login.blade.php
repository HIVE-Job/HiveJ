      ...
      <div class="col-md-6">
        <form method="POST" action="{{ route('login') }}">
          ...
          <div class="row form-group">
            <div class="col-md-12">
              <center>
                <button type="submit" class="btn btn-primary-cs btn-md text-white">Log In</button>
              </center>
            </div>
          </div>
        </form>
        <div class="row form-group">
          <div class="col-md-12">
            <p class="mb-0 text-center">Don't have an account yet? <a class="text-primary" href="{{ route('register') }}"> Register</a></p>
          </div>
        </div>
      </div>
    </div>
