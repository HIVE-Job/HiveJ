        ...
        <div class="dropdown float-right">
          ...
          <div class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
            <div class="dropdown-menu-content">
              <a class="dropdown-item" href="{{route('a.partners')}}">Manage Partners</a>
            </div>
          </div>
        </div>
        <h4 class="mb-0">
      ...
      <div class="card-body pb-0">
        <div class="dropdown float-right">
          ...
          <div class="dropdown-menu" aria-labelledby="dropdownMenuButton2">
            <div class="dropdown-menu-content">
              <a class="dropdown-item" href="{{route('a.applicants')}}">Manage Applicants</a>
            </div>
          </div>
        </div>
        <h4 class="mb-0">
        ...
        <p class="text-light">Active Applicants</p>
      ...
      <div class="card-body pb-0">
        <div class="dropdown float-right">
          ...
          <div class="dropdown-menu" aria-labelledby="dropdownMenuButton3">
            <div class="dropdown-menu-content">
              <a class="dropdown-item" href="{{route('a.vacancies')}}">Manage Jobs</a>
            </div>
          </div>
        </div>
        <h4 class="mb-0">
        ...
        <p class="text-light">Job Offers</p>
      ...
      <div class="card-body pb-0">
        <div class="dropdown float-right">
          ...
          <div class="dropdown-menu" aria-labelledby="dropdownMenuButton4">
            <div class="dropdown-menu-content">
              <a class="dropdown-item" href="{{route('a.applications')}}">Manage Applications</a>
            </div>
          </div>
        </div>
        <h4 class="mb-0">
        ...
        <p class="text-light">Applications Submitted</p>
      ...
      <div class="card-body">
        <div class="stat-widget-one">
          ...
          <div class="stat-content dib">
            <div class="stat-text">Applicants Hired</div>
    ...
    <div class="card">
      <div class="card-body">
        <div class="stat-widget-one">
          ...
          <div class="stat-content dib">
            <div class="stat-text">Open Jobs</div>
