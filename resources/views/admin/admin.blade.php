    ...
    <div class="page-header float-right">
      <div class="page-title">
        <ol class="breadcrumb text-right">
          ...
          <li class="active"><a href="{{route('a.dashboard')}}">Manage Admin</a></li>
        </ol>
      </div>
    </div>
  </div>
      ...
      <div class="col-lg-8">
        <div class="card">
          <div class="card-header">
            <strong class="card-title">Administrator Information</strong>
          </div>
          <div class="card-body">
            <div id="pay-invoice">
              <div class="card-body">
                ...
                <form action="{{route('a.update-admin', ['id'=> $admin->id])}}" method="POST">
                  ...
                  <div class="form-group">
                    <label for="name" class="control-label mb-1">Administrator Name</label>
                  ...
                  <div class="row form-group">
                    <div class="col col-md-3"><label for="role" class="form-control-label">Choose Role</label></div>
                    <div class="col-12 col-md-9">
                      <select name="role" id="role" class="form-control @error('role') is-invalid @enderror">
                        <option value="1" @if($admin->role === 1) selected @endif>Administrator</option>
                        <option value="2" @if($admin->role === 2) selected @endif>Partner</option>
                        <option value="3" @if($admin->role === 3) selected @endif>User (Applicant)</option>
                      </select>
                      @error('role')
                      <div class="text-danger text-sm">{{$message}}</div>
                      @enderror
