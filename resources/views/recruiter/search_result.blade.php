  ...
  <div class="container">
    ...
    <div class="row mb-5 justify-content-center">
      <div class="col-md-7 text-center">
        <h2 class="section-title mb-2">{{$results->count()}} Search Results</h2>
        <span class="badge badge-success mb-3">
          <h2>{{$results->where('job_status', 'open')->count()}} Jobs Still Open</h2>
        </span>
      </div>
    </div>
    ...
    <div class="row mb-5">
      <div class="col-12">
        <a href="{{ url()->previous() }}" class="btn btn-block btn-success btn-md"><span class="fa fa-mail-reply"></span> Back</a>
      </div>
    </div>
