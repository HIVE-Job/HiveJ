    ...
    <div class="container">
        ...
        <div class="row mb-5 justify-content-center">
            <div class="col-md-7 text-center">
                <h2 class="section-title mb-2">Create New Job Vacancy</h2><br>
            </div>
        </div>
            ...
            <div class="col-lg-12">
                <form method="POST" action="{{route('r.create_new_job')}}" enctype="multipart/form-data" class="p-4 p-md-5 border rounded">
                    ...
                    <div class="form-group">
                        <div class="mb-3">
                            <label for="formFile" class="form-label">Upload Illustration Image</label>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control @error('job_title') is-invalid @enderror" id="job_title" name="job_title" placeholder="Example: Rice Harvesting Service" required autofocus value="{{old('job_title')}}">
                        @error('job_title')
                        <div class="text-danger text-sm">{{$message}}</div>
                        @enderror
                    </div>
                    ...
                    <!-- vacancy -->
                    <div class="form-group">
                        <label for="vacancy">Number of Available Positions</label>
                    ...
                    <div class="form-group">
                        ...
                        <select class="selectpicker border rounded  @error('job_category') is-invalid @enderror" id="job_category" name="job_category" data-style="btn-black" data-width="100%" data-live-search="true" title="Select Job Category" required value="{{old('job_category')}}">
                            <option value="freelancer" @if(old('job_category')==='freelancer' ) selected @endif>FreeLancer</option>
                            <option value="fulltime" @if(old('job_category')==='fulltime' ) selected @endif>Fulltime</option>
                        </select>
                        @error('job_category')
                        <div class="text-danger text-sm">{{$message}}</div>
                        @enderror
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control @error('salary') is-invalid @enderror" id="salary" name="salary" placeholder="e.g Rp1,000,000/month" required value="{{old('salary')}}">
                        <div class="text-sm fw-light">Salary can be in the form of a range. Example: Rp2,000,000 - Rp3,500,000</div>
                        @error('salary')
                        <div class="text-danger text-sm">{{$message}}</div>
                        @enderror
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <select class="selectpicker border rounded  @error('gender') is-invalid @enderror" id="gender" name="gender" data-style="btn-black" data-width="100%" data-live-search="true" title="Select Gender" required value="{{old('gender')}}">
