  ...
  <div class="container">
    <div class="row mb-5 justify-content-center">
      <div class="col-md-7 text-center">
        <h2 class="section-title mb-2 text-white">Hive Statistics</h2>
        <p class="lead text-white">Number of jobs you have offered & Applications you have received</p>
      </div>
    </div>
    <div class="row pb-0 block__19738 section-counter">
      <div class="col-6 col-md-6 col-lg-3 mb-5 mb-lg-0">
        ...
        <span class="caption">Jobs Offered</span>
      </div>
      ...
      <div class="col-6 col-md-6 col-lg-3 mb-5 mb-lg-0">
        ...
        <span class="caption">Applications In Progress</span>
      </div>
      ...
      <div class="col-6 col-md-6 col-lg-3 mb-5 mb-lg-0">
        ...
        <span class="caption">Applications Rejected</span>
      </div>
    </div>
  </div>
</section>
...
<section class="site-section">
  <div class="container">
    ...
    <div class="row mb-5 justify-content-center">
      <div class="col-md-7 text-center">
        <h2 class="section-title mb-2">No Offers Yet</h2><br>
        <a href="/recruiter/pekerjaan" class="btn btn-success border-width-2 d-none d-lg-inline-block"><i class="fa fa-plus"></i> Post Job Offer </a>
      </div>
    </div>
    @else
    <div class="row mb-5 justify-content-center">
      <div class="col-md-7 text-center">
        <h2 class="section-title mb-2">{{$posted_job}} Jobs Offered</h2>
      </div>
    </div>
