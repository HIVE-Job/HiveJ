  ...
  <div class="container">
    <div class="row mb-5 justify-content-center">
      <div class="col-md-7 text-center">
        ...
        <p class="lead text-white">Here are the statistics for Hive, including the number of jobs, candidates, approved applications, and companies/partners that have joined.</p>
      </div>
    </div>
    <div class="row pb-0 block__19738 section-counter">
      ...
      <div class="col-6 col-md-6 col-lg-3 mb-5 mb-lg-0">
        ...
        <span class="caption">Filled Jobs</span>
      </div>
      <div class="col-6 col-md-6 col-lg-3 mb-5 mb-lg-0">
        <div class="d-flex align-items-center justify-content-center mb-2">
    ...
    <div class="row mb-5 justify-content-center">
      <div class="col-md-7 text-center">
        ...
        <span class="badge badge-success mb-3">
          <h2>{{$posted_job}} Jobs Still Open</h2>
        </span>
      </div>
    </div>
