<nav class="mx-auto site-navigation">
  <ul class="site-menu js-clone-nav d-none d-xl-block ml-0 pl-0">
    <li><a href="{{route('u.homepage')}}" class="nav-link {{ request()->is('user/homepage') ? 'active' : ''}}">Home</a></li>
    ...
    <li><a href="{{route('u.applications')}}" class="nav-link {{ request()->is('user/application') || request()->is('user/application/*') ? 'active' : ''}}">My Applications</a></li>
