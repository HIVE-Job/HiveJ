  ...
  <div class="container">
    ...
    <div class="row">
      <div class="col-6 col-md-6 col-lg-6 bg-light mb-4 mb-lg-5">
        <a href="{{route('u.freelancer-vacancies')}}" class="block__16443 text-center d-block">
      ...
      <div class="col-6 col-md-6 col-lg-6 bg-light mb-4 mb-lg-5">
        <a href="{{route('u.fulltime-vacancies')}}" class="block__16443 text-center d-block">
          <span class="custom-icon mx-auto"><span class="icon-search d-block"></span></span>
          <h3>Fulltime</h3>
    ...
    <div class="row mb-5 justify-content-center">
      <div class="col-md-8 text-center">
        <h2 class="section-title mb-2">{{$vacancies_total}} Job Offers in the Freelancer Sector</h2>
        <span class="badge badge-success mb-3">
          <h2>{{$available_vacancies}} Open Positions</h2>
        </span>
      </div>
    </div>
    ...
    <ul class="job-listings mb-5">
      ...
      <li class="job-listing d-block d-sm-flex pb-3 pb-sm-0 align-items-center">
        ...
        <div class="job-listing-logo">
          <img src="/user/images/job/{{$vacancy->image}}" alt="company_logo" class="img-fluid">
        </div>
