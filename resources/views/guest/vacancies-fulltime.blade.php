  ...
  <div class="container">
    ...
    <div class="row">
      <div class="col-6 col-md-6 col-lg-6 bg-light mb-4 mb-lg-5">
        <a href="{{route('g.freelancer-vacancies')}}" class="block__16443 text-center d-block">
          ...
          <h3>Freelancer</h3>
          <p>Explore vacancies in the freelancer category only.</p>
        </a>
      </div>
      ...
      <div class="col-6 col-md-6 col-lg-6 bg-light mb-4 mb-lg-5">
        <a href="{{route('g.fulltime-vacancies')}}" class="block__16443 text-center d-block">
          <span class="custom-icon mx-auto"><span class="icon-search d-block"></span></span>
          <h3>Fulltime</h3>
          <p>Explore vacancies in the fulltime category only.</p>
        </a>
      </div>
    </div>
    ...
    <div class="row mb-5 justify-content-center">
      <div class="col-md-8 text-center">
        <h2 class="section-title mb-2">{{$vacancies_total}} Job Offers in the Fulltime Category</h2>
