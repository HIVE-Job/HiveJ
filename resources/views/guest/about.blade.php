  ...
  <div class="container">
    <div class="row align-items-center">
      ...
      <div class="col-lg-5 ml-auto">
        ...
        <p class="lead">Experience minimum, with voluptuous pleasures, when it comes to painless voluptatum ut dolor, but to make the body, which anyone wants to do minus nothing vitae. Sit, voluptatem.</p>
        <p>Lorem ipsum, harum assumenda in eum vel eveniet numquam, cumque vero vitae enim cupiditate deserunt eligendi officia modi consectetur. Expedita tempora quos nobis earum hic ex asperiores quisquam optio nostrum sit!</p>
      </div>
    </div>
  </div>
</section>
  ...
  <div class="container">
    ...
    <div class="row align-items-center block__69944">
      ...
      <div class="col-md-6 order-md-2 ml-md-auto">
        <img src="{{ asset('/user/images/person_5.jpg') }}" alt="Image" class="img-fluid mb-4 rounded">
      </div>
