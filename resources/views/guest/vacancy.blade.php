  ...
  <div class="container">
    <div class="row align-items-center mb-5">
      ...
      <div class="col-lg-4">
        <div class="row">
          <div class="col-12">
            <a href="/login" class="btn btn-block btn-primary-cs btn-md"><i class="fa fa-paper-plane"></i> Apply Now</a>
          </div>
        </div>
      </div>
    </div>
    <div class="row">
      <div class="col-lg-8">
        ...
        <div class="row mb-5">
          ...
          <div class="col-6">
            <a class="btn btn-block btn-primary-cs btn-md" type="submit" href="/login"><i class="fa fa-paper-plane"></i> Apply Now</a>
          </div>
        </div>
      ...
      <div class="col-lg-4">
        <div class="bg-light p-3 border rounded mb-4">
          ...
          <ul class="list-unstyled pl-3 mb-0">
            ...
            <li class="mb-2"><strong class="text-black">Number of Positions:</strong> <br>
