...
Route::middleware('auth', 'user')->group(function () {
    ...
    Route::get('/user/vacancy-freelancer', [UserController::class, 'get_agriculture_vacancies'])->name('u.agriculture-vacancies');
    Route::get('/user/vacancy-fulltime', [UserController::class, 'get_fishery_vacancies'])->name('u.fishery-vacancies');
