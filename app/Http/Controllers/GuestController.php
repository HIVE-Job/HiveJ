...
class GuestController extends Controller
{
    ...
    public function get_freelancer_vacancies()
    {
        ...
        return view('guest.vacancies-freelancer', compact('vacancies', 'vacancies_total', 'available_vacancies'));
    }
    ...
    public function get_fulltime_vacancies()
    {
        ...
        return view('guest.vacancies-fulltime', compact('vacancies', 'vacancies_total', 'available_vacancies'));
    }
